...
do
    ...
    cmake --install _build/"$BUILD_KIT" --prefix _installed/$VARIANT --component allSystemA --config Release
    ...
    cmake --install _build/"$BUILD_KIT" --prefix _installed/$VARIANT --component allSystemB --config Release
    ...
    (cd _build/"$BUILD_KIT" && ctest --verbose --test-dir _build/"$BUILD_KIT" --config Release )
